...
<div class="main-container" id="main-container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <sf:form enctype="multipart/form-data" class="form-horizontal" method="post"
                                 action="/search/get/chengji.do" modelAttribute="requestObject">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="kechengmingcheng" placeholder="课程名"
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <c:if test="${xuesheng!=null}">
                                        <c:forEach items="${xuesheng.kechengs}" var="t">
                                            <tr>
    ...
    <script type="text/javascript">
        ...
        function getKecheng() {
            ...
            $.ajax({
                url: "course/get/kecheng/list/ajax.do",
