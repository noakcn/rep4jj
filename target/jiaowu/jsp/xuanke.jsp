                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <sf:form enctype="multipart/form-data" class="form-horizontal" method="post"
                                 action="course/get/kecheng/list.do" modelAttribute="requestObject">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="mingcheng" placeholder="课程名"
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <c:if test="${kechengList!=null}">
                                        <c:forEach items="${kechengList}" var="t">
                                            <tr>
                                                <td>${t.kechengmingcheng}</td>
                                                <td>${t.xueyuan.mingcheng}</td>
                                                <td>${t.typeStr}</td>
                                                <td>${t.zongkeshi}</td>
                                                <td>${t.xuefeng}</td>
                                                <td id="${t.id}">${t.status}</td>
                                                <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <button class="btn btn-xs btn-success">
                                                            <span class="tooltip-info"
                                                                  ...
                                                                  onclick="doXuanke('${t.id}')"
                                                                  data-original-title="选中">
                                                                <span class="white">
                                                        ...
                                                        <button class="btn btn-xs btn-danger">
                                                            <span class="tooltip-info"
                                                                  data-rel="tooltip" title=""
                                                                  onclick="doTuixuan('${t.id}')"
                                                                  data-original-title="退选">
                                                                <span class="white">
...
<script type="text/javascript">
    ...
    ;
    function doXuanke(id) {

        $.ajax({
            url: "course/do/xuanke.do?id=" + id,
            success: function (data) {
    ...
    function doTuixuan(id) {

        $.ajax({
            url: "course/do/tuixuan.do?id=" + id,
            success: function (data) {
